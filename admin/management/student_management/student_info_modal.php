...
$stmt = $conn->prepare("SELECT lrn, last_name, first_name, middle_name, sex, birth_date, age, mother_tongue, religion, house, barangay, city, province, father, mother, guardian_name, guardian_relation, contact, remarks, registered_by, date_time_registered, status, grade_level, section FROM students WHERE lrn = ?");
...
$stmt->bind_result($lrn, $last_name, $first_name, $middle_name, $sex, $birth_date, $age, $mother_tongue, $religion, $house, $barangay, $city, $province, $father, $mother, $guardian_name, $guardian_relation, $contact, $remarks, $registered_by, $date_time_registered, $status, $grade_level, $section);
$stmt->fetch();
...
<table>
    ...
    <tr><th>Grade Level</th><td><?php echo htmlspecialchars($grade_level); ?></td></tr>
    <tr><th>Section</th><td><?php echo htmlspecialchars($section); ?></td></tr>
