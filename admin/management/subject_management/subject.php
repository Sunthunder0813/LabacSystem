...
<body>
    <div class="wrapper">
        ...
        <div class="breadcrumb" style="display: flex; align-items: center; justify-content: center; gap: 3px; height: 100%;">
                ...
                <span>&#8250;</span>
                <a href="subject.php"><h1>Subject Management</h1></a>
            </div>
            <nav>
                <!-- School Management -->
                <div class="dropdown">
        ...
        <main>
            <p class="welcome-message">Subject Management</p>
            <p>Manage schedules here. (Add your Subject management features.)</p>
        </main>
        <footer>
